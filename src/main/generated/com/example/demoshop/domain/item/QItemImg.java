...
public class QItemImg extends EntityPathBase<ItemImg> {
    ...
    private static final long serialVersionUID = 606749915L;
    ...
    public final EnumPath<com.example.demoshop.domain.item.common.IsMainImg> isMainImg = createEnum("isMainImg", com.example.demoshop.domain.item.common.IsMainImg.class);
